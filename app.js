...
//video progress top up function 
function handleProgress() {
    const videoPos = video.currentTime / video.duration;
    progressBartop.style.width = videoPos * 100 + "%";
    if (videoPos * 100 === 100) {
        videoReset();
    }
}

progress_top.addEventListener('click', (e) => {
    const timeProgress = (e.offsetX / progress_top.offsetWidth) * video.duration;
